...
private fun Fragment.goByGameId(id: String, title: String, thumb: String) {
    if (id.isBlank()) {
        Toast.makeText(context, "Oyun ID bos", Toast.LENGTH_SHORT).show()
        return
    }
    try {
        startActivity(
        ...
        Toast.makeText(context, "Acilamadi: ${e.message}", Toast.LENGTH_LONG).show()
    }
}
...
private fun Fragment.goByDealId(id: String, title: String, thumb: String) {
    if (id.isBlank()) {
        Toast.makeText(context, "Firsat ID bos", Toast.LENGTH_SHORT).show()
        return
    }
    try {
        startActivity(
